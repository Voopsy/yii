...
<header id="header">
    <?php
    NavBar::begin([
        'brandLabel' => '<img style="border-radius:20px;" src="" class=""/>Духи',
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div style="font-size:20px;margin-top:30px" class="col-md-6 text-center text-md-start">&copy; Духи <?= date('Y') ?></div>
